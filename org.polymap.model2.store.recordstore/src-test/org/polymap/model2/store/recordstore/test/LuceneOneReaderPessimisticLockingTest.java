 ...
 */
public class LuceneOneReaderPessimisticLockingTest
    ...
    protected void setUp() throws Exception {
        ...
        repo = EntityRepository.newConfiguration()
                ...
                .entities.set( new Class[] {OneReaderLocked.class} )
                .create();
        
        setUpEntities( OneReaderLocked.class );
    }
    
    
    @Concerns( OneReaderPessimisticLocking.class )
    public static class OneReaderLocked
            extends Locked {
